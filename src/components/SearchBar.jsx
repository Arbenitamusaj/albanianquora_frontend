...
function SearchBar() {
    ...
    return (
        ...
        <input placeholder="Search a topic" className="rounded-full w-full h-10 bg-transparent py-2 pl-8 pr-32 outline-none border-2 border-gray-100 shadow-md hover:outline-none focus:ring-teal-200 focus:border-teal-200" type="text" name="query" id="query"/>
        <button type="submit" className="absolute inline-flex items-center h-8 px-4 py-1 text-sm text-white transition duration-150 ease-in-out rounded-full outline-none right-3 top-1/2 transform -translate-y-1/2 bg-teal-600 sm:px-6 sm:text-base sm:font-medium hover:bg-teal-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-teal-500">
